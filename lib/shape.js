...
class Triangle extends Shape {
    ...
    renderTriangle(){
        ...
        return `${renderSVG()}<polygon points="150, 18 244, 182 56, 182" fill="green" /><text x="150" y="140" font-size="55" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`
    }
