...
describe('Triangle',()=>{
    ...
    describe('renderTriangle()',()=>{
        it('should return a template literal',()=>{
            ...
            expect(tri.renderTriangle()).toEqual(`${renderSVG()}<polygon points="150, 18 244, 182 56, 182" fill="green" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="gold">JOR</text></svg>`)
        })
    })
});
